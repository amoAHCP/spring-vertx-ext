 ...
 * You can also reuse cspring configurations for different verticles. The autoremoveOtherSpringVerticles defines if you Spring verticle should be the only one in spring context.
